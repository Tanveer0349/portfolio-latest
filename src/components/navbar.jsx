...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full h-20 px-4 bg-black fixed">
      <div>
        <h1 className="text-5xl font-signature text-pink-500 ml-2">Tanveer</h1>
      </div>
      ...
      {nav && (
        <ul className="flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-black to-gray-800 text-pink-500">
          {links.map(({ id, link }) => (
            <li
              key={id}
